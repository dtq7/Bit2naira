    ...
    <section id="bitcoin-deposit" class="s-about target-section">
        ...
        <div class="row">
            <div class="col-six tab-full">
                ...
                <form>
                    <div>
                            <label for="sampleInput">Total Amt Bitcoin</label>
                            <input class="full-width" type="text" placeholder="Total BTC Amount" id="sampleInput">
                    </div>
                    <div>
                            <label for="sampleRecipientInput">BTC Address</label>
                            <div class="cl-custom-select">
                                <select class="full-width" id="sampleRecipientInput">
                                    <option value="Option 1">Other Wallet</option>
                                    <option value="Option 2">Local Bitcoin</option>
                    ...
                    <table class="table color-table primary-table" id="ju">
                                ...
                                <form>
                                   ...
                                   <div>
                                    ...
                                    <label for="sampleInput">Number if Bitcoin Sold</label>
                            <input class="full-width" type="text" placeholder="Total BTC Amount" id="sampleInput">
                             <input class="btn--primary full-width" type="submit" value="Submit">
