    ...
    <section id="home" class="s-home page-hero target-section" data-parallax="scroll" data-image-src="images/vb.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h1><span style="color:green;font-weight:bold">
                Bit2Naira </span><br>
   ...
   <!-- end s-about -->
    ...
    <section id="services" class="s-about target-section">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead text-center">THE REQUIREMENTS OF GIFT CARDS( MOST IMPORTANT) </h3>
                <div class="row">
            <div class="col-six tab-full">
                <h4 style="color:green">Itunes Card:</h4></div></div>
                 <p class="">
        ...
        <div class="row about-process block-1-2 block-tab-full">
                                <h4 class="card-title text-center subhead">Itunes Gift Card Trading</h4>
                                <h6 class="card-subtitle"><img src="images/p.png" alt="" width="11%"/><span><p> $100=<br>20000</p></span></h6>
                            ...
                            <div class="row about-process block-1-2 block-tab-full">
                                <h4 class="card-title text-center subhead">Amazon Gift Card Trading</h4>
                                <h6 class="card-subtitle"><img src="images/a.png" alt="" width="11%"/><span><p> $100=<br>20000</p></span></h6>
                            ...
                            <div class="row">
            <div class="col-six tab-full">
                <p style="background-color:red;color:white">Notice: We dont pay if any of your single card exceeds 100$ for itunes card</p>
                <form>
                    <div>
                            <label for="sampleInput">Total Amt ($)</label>
                            <input class="full-width" type="text" placeholder="Input the Amount you want to sell, ex: if you have 50$*10, input 500" id="sampleInput">
                    </div>
                    <div>
                            <label for="sampleRecipientInput">Card Type</label>
                            <div class="cl-custom-select">
                                <select class="full-width" id="sampleRecipientInput">
                                    <option value="Option 1">Itunes gift card</option>
                                    <option value="Option 2">Amazon Gift card </option>
                     ...
                     <div>
                            <label for="sampleRecipientInput">Denomination Type</label>
                            <div class="cl-custom-select">
                                <select class="full-width" id="sampleRecipientInput">
                                    <option value="Option 1">USD</option>
                                    <option value="Option 2">Naira</option>
                    ...
                    <label for="exampleMessage">User Remarks</label>
                        <input class="full-width" type="text" placeholder="Your remark/Optional" id="exampleMessage"/>
