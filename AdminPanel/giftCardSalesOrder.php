...
if(isset($_POST['confirm'])){
  ...
  $sqlConfirm = $con->query("UPDATE GiftCardSaleOrder SET Addressed=1 WHERE id='$id'");
}
       ...
       if($mail->send()){
         //if(true){
          //Delete the record
            ...
            $sqlDeny = $con->query("UPDATE GiftCardSaleOrder SET Addressed=1 WHERE id='$id'");
       }
...
<head>
  ...
  <title>Admin Panel | GiftCard Sales Order</title>
  <!-- Bootstrap core CSS -->
  <link href="css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="./special/dataTables.bootstrap.min.css">
  <link href="css/style.css" rel="stylesheet">
  <link rel="stylesheet" href="./css/giftCardSalesOrder.css">
</head>
...
<body>
    ...
    <div class="container-fluid custom-container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="giftCardSalesOrder.php">GIFTCARDSALES</a></li>
  ...
  <header id="header">
    <div class="container-fluid custom-container">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> GSO <small>Manage Your Gift Card Orders</small></h1>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container-fluid custom-container">
      ...
      <div class="row">
        <?php
          ...
          $sqlOrder = $con->query("SELECT * FROM GiftCardSaleOrder where Addressed=0");
          ...
          while($row = $sqlOrder->fetch_assoc()){
            ...
            echo ' <form enctype="multipart/form-data" action="giftCardSalesOrder.php" method="post">
            <div class="row">
            ...
            <div class="col-md-8 well info_wrapper">
              <div class="info_section">
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item">AMOUNT: <span class="sep">'.$amount.' Naira</span> </li>
                  <li class="list-group-item">CT: <span class="sep">'.$card.' Btc</span> </li>
                  <li class="list-group-item">DENOMINATION: <span class="sep">'.$denomination.' Btc</span> </li>
                </ul>
...
?>
  ...
  <script src="./js/giftCardSalesOrder.js"></script>
</body>
