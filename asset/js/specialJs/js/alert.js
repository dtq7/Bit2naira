...
(function($) {
    $.alert_ext = {
        ...
        defaults: {
            autoClose: true, // 自动关闭
            closeTime: 6000, // 自动关闭时间，不少于1000
            withTime: true, // 添加计时  会在文字后面添加  ...10
            type: 'info', // 提示类型
        ...
        // 提示框模版
        tmpl: '<div style="border-radius:10px;margin:40px 40px 0 0;" class="alert alert-dismissable ${State}"><button style="display:none" type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><h4 style="white-space: nowrap;">${Title}</h4><p>${Content}</p></div>',
